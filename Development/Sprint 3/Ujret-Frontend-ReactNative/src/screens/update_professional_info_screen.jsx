...
// Api layer import
import {updateHandyman} from '../api_layer/handymen_apis';

// Redux imports
import {setHandyman} from '../stores/handyman_slice';

// Main screen component
const UpdateProfessionalInfo = ({route, navigation}) => {
  // Redux Dispatcher
  ...
  // State hooks
  const [handymanId, setHandymanId] = useState('');
  const [updatedCatgeories, setUpdatedCategories] = useState(categories);
  ...
  useEffect(() => {
    if (handymanInfo) {
      setHandymanId(handymanInfo.handymanId);
      setExperience(handymanInfo.experience);
      setAbout(handymanInfo.about);
      setAddress(handymanInfo.address);
    }
  }, [handymanInfo]);
  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await updateHandyman(
        handymanId,
        updatedCatgeories,
        experience,
        about,
