...
// Get User All Tasks
// {{URL}}/get-user-all-tasks?user_id=fb3f7757-6445-5100-a205-558c287dc656
const getUserAllTasks = async userId => {
  try {
    const apiResponse = await fetch(
      `${BASE_URL}/get-user-all-tasks?user_id=${userId}`,
      // `${BASE_URL}/get-user-all-tasks?user_id=${'fb3f7757-6445-5100-a205-558c287dc656'}`,
      {
        method: 'GET',
        headers: {
          Accept: 'application/json',
...
// get all handynan tasks
// {{URL}}/get-handyman-all-tasks?handyman_id=aba7f764-d6c1-4001-a6e8-dd45176345dc
const getHandymanAllTasks = async handymanId => {
  try {
    const apiResponse = await fetch(
      `${BASE_URL}/get-handyman-all-tasks?handyman_id=${handymanId}`,
      {
        method: 'GET',
        headers: {
          Accept: 'application/json',
