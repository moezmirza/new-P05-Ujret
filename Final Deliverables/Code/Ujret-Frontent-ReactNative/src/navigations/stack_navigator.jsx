...
import TasksHistoryScreen from '../screens/tasks_history_screen';

// Renting
import AddRentingToolScreen from '../screens/add_renting_tool';
import RentingHomeScreen from '../screens/renting_home_screen';
import ToolCard from '../screens/catalog_search';
import EditRentingTool from '../screens/edit_renting_tool';
import ToolDetailScreen from '../screens/tool_detail_screen';
  ...
  return (
    <Stack.Navigator initialRouteName="Splash">
      ...
      <Stack.Screen
        ...
        // options={{headerShown: false}}
        options={{headerShown: true, title: 'Tasks History'}}
      />

      {/* Renting */}
      <Stack.Screen
        name="RentingHomeScreen"
        component={RentingHomeScreen}
        options={{headerShown: false}}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name="EditRentingTool"
        component={EditRentingTool}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="ToolDetailScreen"
